function [word,pass] = parityCheck(word, D29Star, D30Star)
...
%
%[word,pass] = parityCheck(word, D29Star, D30Star)
%
%   Inputs:
...
%                   (character array).
%       pass        - flag value to check if the parity check passes
%--------------------------------------------------------------------------
...
% Set the default value for 'pass' flag
pass=1;
