function [satPositions, satClkCorr,satVolocity,satClkCorrRat] = ...
    satposvel_L2C(transmitTime, prnList,eph)
%SATPOS Calculation of position and velocity satellites coordinates at TRANSMITTIME
...
%       satVolocity   - velocity of satellites (in ECEF system [Vx; Vy; Vz])
%       satClkCorrRat - correction of satellites clock drift
